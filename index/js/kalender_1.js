const calendar = document.querySelector(".calendar"),
  ...
  eventPassword = document.querySelector(".event-password");
...
addEventSubmit.addEventListener("click", () => {
  ...
  if (eventTitle === "" || eventTimeFrom === "" || eventTimeTo === "" || password === "") {
    alert("Please fill all the fields");
    return;
  }
  if (password !== "sandi_123") {
...
eventsContainer.addEventListener("click", (e) => {
  if (e.target.classList.contains("event")) {
    ...
    if (password === "sandi_123") { // ganti 'yourPassword' dengan kata sandi yang Anda inginkan
